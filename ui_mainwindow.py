...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.ordenar_por_id_pushButton = QPushButton(self.groupBox)
        self.ordenar_por_id_pushButton.setObjectName(u"ordenar_por_id_pushButton")

        self.gridLayout.addWidget(self.ordenar_por_id_pushButton, 14, 0, 1, 2)
        ...
        self.ordenar_por_distancia_pushButton = QPushButton(self.groupBox)
        self.ordenar_por_distancia_pushButton.setObjectName(u"ordenar_por_distancia_pushButton")

        self.gridLayout.addWidget(self.ordenar_por_distancia_pushButton, 15, 0, 1, 2)

        self.ordenar_por_velocidad_pushButton = QPushButton(self.groupBox)
        self.ordenar_por_velocidad_pushButton.setObjectName(u"ordenar_por_velocidad_pushButton")

        self.gridLayout.addWidget(self.ordenar_por_velocidad_pushButton, 16, 0, 1, 2)
        ...
        self.gridLayout_3.addWidget(self.tabla_tableWidget, 0, 0, 1, 7)
        ...
        self.ordenar_por_velocidad_pushButton_2 = QPushButton(self.tabla_tab)
        self.ordenar_por_velocidad_pushButton_2.setObjectName(u"ordenar_por_velocidad_pushButton_2")

        self.gridLayout_3.addWidget(self.ordenar_por_velocidad_pushButton_2, 1, 5, 1, 1)
        ...
        self.ordenar_por_id_pushButton_2 = QPushButton(self.tabla_tab)
        self.ordenar_por_id_pushButton_2.setObjectName(u"ordenar_por_id_pushButton_2")

        self.gridLayout_3.addWidget(self.ordenar_por_id_pushButton_2, 1, 3, 1, 1)

        self.ordenar_por_distancia_pushButton_2 = QPushButton(self.tabla_tab)
        self.ordenar_por_distancia_pushButton_2.setObjectName(u"ordenar_por_distancia_pushButton_2")

        self.gridLayout_3.addWidget(self.ordenar_por_distancia_pushButton_2, 1, 4, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.ordenar_por_velocidad_pushButton_2.setText(QCoreApplication.translate("MainWindow", u"Ordenar por velocidad", None))
        ...
        self.ordenar_por_id_pushButton_2.setText(QCoreApplication.translate("MainWindow", u"Ordenar por id", None))
        self.ordenar_por_distancia_pushButton_2.setText(QCoreApplication.translate("MainWindow", u"Ordenar por distancia", None))
