...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.ui.ordenar_por_id_pushButton_2.clicked.connect(self.sort_by_id)
        self.ui.ordenar_por_distancia_pushButton.clicked.connect(self.sort_by_distancia)
        self.ui.ordenar_por_distancia_pushButton_2.clicked.connect(self.sort_by_distancia)
        self.ui.ordenar_por_velocidad_pushButton.clicked.connect(self.sort_by_velocidad)
        self.ui.ordenar_por_velocidad_pushButton_2.clicked.connect(self.sort_by_velocidad)
